#!/usr/bin/env python3
"""
West Wall Cycled - Create continuous west wall from newski connector pieces.

Combines: leftmidtower{small,med,large} + westeastconnector
Outputs: build/citadel_west_wall.png (tileable horizontal strip)
"""
...
def create_west_wall() -> None:
    """Create west wall by cycling tower sizes with connectors."""
    
    # Load components
    try:
        small = Image.open(BUILD_DIR / "newski_leftmidtowersmall.png")
        med = Image.open(BUILD_DIR / "newski_leftmidtowermed.png")
        large = Image.open(BUILD_DIR / "newski_leftmidtowerlarge.png")
    ...
    out_path = BUILD_DIR / "citadel_west_wall.png"
