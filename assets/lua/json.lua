--
-- json.lua (rxi/json.lua) -- MIT-licensed JSON encode/decode for Lua.
-- https://github.com/rxi/json.lua
-- Bundled here because Aseprite's Lua environment has no built-in json module.
--
-- Copyright (c) 2020 rxi -- see header below for full license.
--
